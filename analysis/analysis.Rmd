...
# function to perform between groups t test, along with summary stats, Hedges' g, and Bayes Factor using default prior (r = .707) -----
analysis_workflow <- function(data) {
  ...
  results_hedges_g <- data.frame(hedges_g        = round(results_hedges_g_temp$t0,        3),
                                 hedges_g_se     = round(sd(results_hedges_g_temp$t),     3),
                                 hedges_g_ci_lwr = round(results_hedges_g_temp$bounds[1], 3),
                                 hedges_g_ci_upr = round(results_hedges_g_temp$bounds[2], 3))
