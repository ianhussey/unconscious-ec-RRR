...
data_awareness_1_for_hand_scoring <- read.csv("intermediate/data_awareness_for_hand_scoring.csv") %>%
  select(unique_id, 
...
data_processed <- left_join(data_intermediate, data_awareness_1_for_hand_scoring, by = "unique_id") %>%
  ...
  select(unique_id, 
         ...
         # DV
         sum_score_evaluation_CS1_preferred, 
         # other variables
         condition,
         perc_accuracy_surveillance_response, 
         sum_score_filler_1, 
         sum_score_filler_2, 
         ...
         sd_perc_accuracy_surveillance_response_by_site, 
         fazio_and_olsen_criteria_scorer_1, 
         fazio_and_olsen_modified_criteria_scorer_1, 
         fazio_and_olsen_criteria_scorer_2, 
         fazio_and_olsen_modified_criteria_scorer_2)
