...
text(-1.1, 14, substitute(paste("(a) Olson & Fazio (2001) criterion (", italic('n'), " = 1340)")), pos = 4)
...
text(-1.1, 14, substitute(paste("(b) Olson & Fazio (2001) modified criterion (", italic('n'), " = 1007)")), pos = 4)
text(1.6, 13.97, substitute(paste(italic('g'), " [95% CI]")), pos = 2)
...
text(-1.1, 14, substitute(paste("(c) Bar-Anan et al. (2010) criterion (", italic('n'), " = 755)")), pos = 4)
text(1.6, 13.97, substitute(paste(italic('g'), " [95% CI]")), pos = 2)
...
text(-1.1, 14, substitute(paste("(d) Bar-Anan et al. (2010) modified criterion (", italic('n'), " = 1060)")), pos = 4)
text(1.6, 13.97, substitute(paste(italic('g'), " [95% CI]")), pos = 2)
