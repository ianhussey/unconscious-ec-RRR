...
data_exclusions_temp_2 <- data_combined %>%
  ...
  mutate(exclude_surveillance = ifelse(perc_accuracy_surveillance_response <
                                         (mean_perc_accuracy_surveillance_response_by_site - 
                                            sd_perc_accuracy_surveillance_response_by_site*3), TRUE, FALSE))
