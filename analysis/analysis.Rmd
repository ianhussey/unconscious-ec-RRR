...
In one sense, all of the analyses below are "confirmatory" in the sense that all were preregistered. In another sense, the Olson & Fazio (2001) exclusion criteria represents the closest replication of the original study's method, and therefore is used as the confimatory test for closely (but not exactly) replicating the original study's effect, whereas the other three methods are "exploratory" in the sense that they test the underlying verbal hypothesis.
...
# Power analysis of existing literature
...
data_existing_literature %>%
  ...
  do(power = pwr.t.test(n = .$analyzed.N, 
                        d = 0.12,   # meta effect size in RRR using confirmatory Olson and Fazio criteria  
                        sig.level = 0.05, 
                        power = NULL, 
                        type = c("one.sample"),
